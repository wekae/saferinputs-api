        ...
        <div class="col-md-8 offset-md-2">
            ...
            @auth
                <div class="card">
                    ...
                    <div class="card-body">
                        <form  class="needs-validation" novalidate method="post" action="/users/{{$user->koan_users_id}}/account/activate">
                            @csrf
                            <div class="form-row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right align-items-end">
                                            ...
                                            <button type="submit" class="btn btn-success m-1">Activate</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
