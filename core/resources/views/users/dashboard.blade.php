...
{{--    <link rel="stylesheet" href="https://cdn.datatables.net/v/bs4/dt-1.10.21/cr-1.5.2/sp-1.1.1/sl-1.3.1/datatables.min.css"/>--}}
{{--    <link rel="stylesheet" href="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css"/>--}}
{{--    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/dt-1.10.21/cr-1.5.2/r-2.2.5/sp-1.1.1/datatables.min.css"/>--}}
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/dt-1.10.21/cr-1.5.2/r-2.2.5/sp-1.1.1/sl-1.3.1/datatables.min.css"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card text-white bg-gradient-primary">
                                    <div class="card-body card-body pb-3 d-flex justify-content-between align-items-start">
                                        <div>
                                            <div class="text-value-xl">{{$active_user_accounts ?? 0}}</div>
                                            <div>Activated User Accounts</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card text-white bg-gradient-info">
                                    <div class="card-body card-body pb-3 d-flex justify-content-between align-items-start">
                                        <div>
                                            <div class="text-value-xl">{{$accounts_pending_verification ?? 0}}</div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card text-white bg-gradient-warning">
                                    <div class="card-body card-body pb-3 d-flex justify-content-between align-items-start">
                                        <div>
                                            <div class="text-value-xl">{{$deactivated_accounts ?? 0}}</div>
...
@section('scripts')
    ...
    {{--    Datatables CDN--}}
{{--    <script type="text/javascript" src="https://cdn.datatables.net/v/bs4/dt-1.10.21/cr-1.5.2/sp-1.1.1/sl-1.3.1/datatables.min.js"></script>--}}
{{--    <script type="text/javascript" src="https://cdn.datatables.net/v/bs4/dt-1.10.21/cr-1.5.2/r-2.2.5/sp-1.1.1/datatables.min.js"></script>--}}
    <script type="text/javascript" src="https://cdn.datatables.net/v/bs4/dt-1.10.21/cr-1.5.2/r-2.2.5/sp-1.1.1/sl-1.3.1/datatables.min.js"></script>
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: function ( data, type, row ) {
                            switch (data) {
                                case 1:
                                    return '<span class="badge bg-success p-2 text-white">Yes</span>';
                                case 0:
                                    return '<span class="badge bg-danger p-2 text-white">No</span>';
                                default:
                                    return '<span class="badge bg-warning p-2 text-white">No</span>';
                            }
                        }
                    },
                    {
                        ...
                        render: function ( data, type, row ) {
                            return '<div class="dropdown">\n' +
                                ...
                                '    <a class="dropdown-item" href="/users/'+data+'/details">Details</a>\n' +
                                '    <a class="dropdown-item" href="/users/'+data+'/edit">Edit</a>\n' +
                                '    <a class="dropdown-item" href="/users/'+data+'/access_level/edit">Change Access Level</a>\n' +
                                '  </div>\n' +
                                '</div>';
                        }
                    },
