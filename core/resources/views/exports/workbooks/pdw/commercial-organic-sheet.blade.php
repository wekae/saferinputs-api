...
<table>
    <thead>
    <tr>
        <th style="background-color: #fffe1f;">Pest, Disease, Weed ID</th>
    ...
    <tbody>
    @forelse($pdw as $pdwItem)
        @forelse($pdwItem->commercialOrganic as $item)
            <tr>
                <td style="font-size:10px; vertical-align: top;">{{ $pdwItem->id }}</td>
