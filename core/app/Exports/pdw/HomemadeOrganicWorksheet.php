...
class HomemadeOrganicWorksheet implements WithStyles, WithColumnWidths, ShouldAutoSize, WithEvents, FromView, WithTitle
{
//    private $month;
//    private $year;
//
...
//    }
    ...
    {
        return view('exports.workbooks.pdw.homemade-organic-sheet', [
...
//            'F' => ['font' => ['bold' => false]],
            ...
            'F'  => ['font' => ['size' => 10.0], 'alignment' => ['vertical' => 'top', 'wrapText' => true]], // External Links
            'G'  => ['font' => ['size' => 10.0], 'alignment' => ['vertical' => 'top', 'wrapText' => true]], // References
...
//                ;
    ...
    {
        return 'Homemade Organic Solutions';
    }
}
