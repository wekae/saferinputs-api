...
class GapWorksheet implements WithStyles, WithColumnWidths, ShouldAutoSize, WithEvents, FromView, WithTitle
{
//    private $month;
//    private $year;
//
...
//    }
    ...
    {
        return view('exports.workbooks.pdw.gap-sheet', [
...
//            'F' => ['font' => ['bold' => false]],
            ...
            'E'  => ['font' => ['size' => 10.0], 'alignment' => ['vertical' => 'top', 'wrapText' => true]], // Practices
