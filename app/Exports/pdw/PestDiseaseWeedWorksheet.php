...
class PestDiseaseWeedWorksheet implements WithStyles, WithColumnWidths, ShouldAutoSize, WithEvents, FromView, WithTitle
{
//    private $month;
//    private $year;
//
...
//    }
    ...
    {
        return view('exports.workbooks.pdw.pdw-sheet', [
