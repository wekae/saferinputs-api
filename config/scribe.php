...
return [
     ...
     */
    'title' => "Safer Inputs API Documentation",

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'This is a guide on how to access and manipulate resources for the safer inputs database.   ',
    ...
    'routes' => [
        [
            ...
            'match' => [
                 ...
                 */
                'prefixes' => [
                    'api/active_ingredients',
                    'api/active_ingredients/*',
                    'api/agrochem',
                    'api/agrochem/*',
                    'api/commercial_organic',
                    'api/commercial_organic/*',
                ],
